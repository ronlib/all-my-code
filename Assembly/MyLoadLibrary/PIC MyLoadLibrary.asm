...
OneArgFunc typedef proto arg1 : dword
TwoArgFunc typedef proto : dword, : dword

MemCopyTypedef typedef proto Source:PTR BYTE, Dest:PTR BYTE, ln:DWORD
...
loadFromBuffer proc bufAddr:dword
	...
	; Let's find out the size of the image, and copy the headers to it
	
	lea ebx, [findImageMappedSizeLabel - getEip1 + ebx]
	assume ebx : OneArgFunc	
	invoke ebx, [bufAddr]	
...
; ------------------------ findImageMappedSize function ------------------------
findImageMappedSizeLabel:
